...
import { renderer, scene, camera, IS_MOBILE, loadFrostBottleGlb, frostBottleReady, loadBarrelGlb, barrelReady } from './render-core.js';
...
window.__lab = { labGroup, labAnimated, flicker: () => LOW_FLICKER, floorFx: () => floorFxGroup, stationsPowered: () => stationsPowered, podGlbReady: () => _podGlbReady, frostBottleReady: () => frostBottleReady(), barrelReady: () => barrelReady(), domeVisible: () => _domeShown, fxLow: () => FX_LOW }; // debug hook(headless 測試用)
let _lastT = 0;
