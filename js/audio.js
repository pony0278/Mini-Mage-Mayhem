...
const SFX = {
  heartbeat: () => { tone({ freq: 62, f1: 38, type: 'sine', dur: 0.15, gain: 0.40 }); tone({ freq: 54, f1: 33, type: 'sine', dur: 0.19, gain: 0.30, at: 0.17 }); }, // flow-2c 瀕界:低頻兩下(lub-dub)——只給快被記滿的本機玩家,聲音層不佔畫面
