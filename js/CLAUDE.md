...
| `v2-terrain.js` | ~115 | TERRAIN 旗標(**rim=正式**/flat/isles/grid)、建地、onSolid、橋導軌。**ring-1 開放邊緣(朋友提案、使用者拍板「對等計分+儀式分級」2026-07-29)**:`RIM={m:64,corner:230}`——實心=內圈矩形∪四角平台(元素站腳下),四條邊帶=廢料井(`RIMMED` 旗;onSolid 摺象限判角平台)。掉下去也算一分(見 v2-combat resolveFall) |
