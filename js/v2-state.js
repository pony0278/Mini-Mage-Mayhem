...
// 與 brawler-clips.js 各 clip 的 impact frame 對齊——改動作時序要兩邊一起改:
//   rhook impact @17f=0.283s、lhook @14f=0.233s、overhand @23f=0.383s(使用者自編三連擊)。
// 起手期間被打暈/被抓/被推開踉蹌 → 打擊取消(格擋推開從此是真反制)。
export const STRIKE_DELAY = [0.283, 0.233, 0.383];
