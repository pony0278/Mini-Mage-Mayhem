...
export const PUSH_WIN = 0.55, PUSH_CDT = 3, PUSH_RANGE = 70, PUSH_FORCE = 380, PUSH_STAGGER = 0.45, AI_PUSH_CHANCE = 0.35;
export const STUN_T = 1.2, STUN_RECOVER = 40, RESTUN_IMMUNE = 0.6;
export const GRAB_RANGE = 46, CARRY_SLOW = 0.6, REGRAB_CD = 0.6;
export const CARRY_ESCAPE_NEED = 100, CARRY_MASH_AI = 45, CARRY_MASH_TAP = 8; // AI 固定填速≈2.2s;人類左右交替每下+8
