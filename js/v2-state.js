...
export const inc = { falls: [0, 0], knockoffs: [0, 0], selfFalls: [0, 0], types: new Set(), matchT: 0,
  ...
  throws: [0, 0], throwContains: 0, parries: 0, cleaned: [0, 0], sorted: [0, 0], missorts: [0, 0] };
export function resetInc() {
  ...
  inc.types = new Set(); inc.matchT = 0; inc.pushOffs = 0; inc.throws = [0, 0]; inc.throwContains = 0; inc.parries = 0; inc.cleaned = [0, 0]; inc.sorted = [0, 0]; inc.missorts = [0, 0];
}
