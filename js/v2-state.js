...
export const ITEM_TYPES = ['wind', 'teleport', 'fire'];
export const ITEM_INFO = { wind: { name: '風壓手套', color: '#bfeaff' }, teleport: { name: '傳送符', color: '#c98cff' }, fire: { name: '噴火帽', color: '#ff7a3a' }, ice: { name: '冰霜瓶', color: '#9fd8ff' }, oil: { name: '潤滑油瓶', color: '#c9a86a' } }; // ice/oil 只剩名字/顏色(瓶 prop 的浮字/標記沿用)
...
export const inc = { falls: [0, 0], knockoffs: [0, 0], selfFalls: [0, 0], types: new Set(), matchT: 0,
  contains: [0, 0], overloads: 0, selfPods: 0, barrelBooms: 0, itemUses: { wind: 0, teleport: 0, fire: 0 },
