...
export const ITEM_TYPES = ['wind', 'teleport', 'fire', 'water'];
export const ITEM_INFO = { wind: { name: '風壓手套', color: '#bfeaff' }, teleport: { name: '傳送符', color: '#c98cff' }, fire: { name: '噴火帽', color: '#ff7a3a' }, water: { name: '工業重錘', color: '#4da6ff' }, ice: { name: '冰霜瓶', color: '#9fd8ff' }, oil: { name: '潤滑油瓶', color: '#c9a86a' } }; // ice/oil 只剩名字/顏色(瓶 prop 的浮字/標記沿用)
...
export const ITEM_WEIGHT = { wind: 2, fire: 2, water: 2, teleport: 1 };
...
export const BOTTLE_SPOTS = [[300, 180, 'oil'], [660, 180, 'ice'], [300, 460, 'ice'], [660, 460, 'oil']];
...
export const inc = { falls: [0, 0], knockoffs: [0, 0], selfFalls: [0, 0], types: new Set(), matchT: 0,
  contains: [0, 0], overloads: 0, selfPods: 0, barrelBooms: 0, itemUses: { wind: 0, teleport: 0, fire: 0, water: 0 },
