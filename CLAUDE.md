...
- `smokeroom.html` — repo-only **v2 道具測試間**(smoke-1;v2 版 training:給道具/彈藥無限/假人 AI·無敵·解狀態/地板化學鋪設;`window.__smokeroom` hook)。Loads `v2.js` + `v2-smokeroom.js`(面板不進正式頁與 portal build)。
