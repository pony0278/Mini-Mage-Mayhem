...
const SUITES = [
  ...
  ['skinrig',   '蒙皮 GLB 角色 ugc-1(骨名別名表 native+VRM 各 16 骨/clone 重綁骨架/蒙皮真變形/定位/縮骨頭/剛體不受影響)'],
  ...
  ['ring',      '開放邊緣+墜落計分 ring-1(rim 地形/走出邊=對手得分 fall/自摔·擊落歸因/終局廢料井封存/AI 邊緣迴避/道具落井)'],
  ['perform',   '回收演出+儀式分級 ring-1(前兩分輕演出快節奏/賽點才開完整演出 n=3/不二次收容/壓縮→報告)'],
  ...
  ['combo',     '連段系統 brawl-3+combo-3b(三連黏臉/終結技必挑飛(滿穩定也飛)/前段暈原地/已暈再擊挑飛/風壓接送/頓點=時間停)'],
